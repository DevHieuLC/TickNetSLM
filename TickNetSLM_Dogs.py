...
def main():
    ...
    for typesize in arr_typesize:    
        type_md = {'small': 'SM', 'large': 'LM'}.get(typesize, typesize)
        strmode = 'StanfordDogs_TickNet_' + type_md + '_SE'  
        ...
        if args.evaluate:
            pathcheckpoint = f"./checkpoints/StanfordDogs/{type_md}/model_best.pth"
